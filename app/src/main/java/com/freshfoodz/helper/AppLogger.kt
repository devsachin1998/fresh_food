...
import com.freshfoodz.BuildConfig
...
object AppLogger {
    ...
    fun e(msgInt: Int, msg: Boolean) {
        if (BuildConfig.DEBUG) {
            Log.e(msgInt.toString(), msg.toString() + "")
        }
    }
    ...
    private fun jsonString(obj: Any): String {
        return MyApplication.gson?.toJson(obj).toString()
    }
}